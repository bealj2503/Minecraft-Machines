...
public class CableBlock extends SixWayBlock implements IWrenchable {
    ...
    @Nullable
    @Override
    public TileEntity createTileEntity(BlockState pos, IBlockReader world){
    ...
    public ActionResultType onWrench(ItemUseContext context) {
        ...
        ExampleMod.LOGGER.debug("onWrench: {}", relative);
