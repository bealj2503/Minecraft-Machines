...
public class CarbonGeneratorScreen extends AbstractMachineBaseScreen<CarbonGeneratorContainer> {
    public static final ResourceLocation TEXTURE = ExampleMod.getId("textures/gui/coal_generator.png");

    public CarbonGeneratorScreen(CarbonGeneratorContainer container, PlayerInventory playerInventory, ITextComponent titleIn) {
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTicks, int x, int y) {
        ...
        if (menu.isBurning()) {
            ...
            blit(matrixStack, xPos + 57, yPos + 53 + 12 - height, 176, 12 - height, 14, height + 1);
        }
